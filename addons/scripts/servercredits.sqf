...
_role1 = "Bem vindo(a) ao";
_role1names = ["A3 Bad Company"];
_role2 = "Thermal";
_role2names = ["Quadcopter UAV e Nightstalker"];
_role3 = "Limite ATM";
_role3names = ["$100,000,000"];
_role4 = "Horarios de RESTART";
_role4names = ["00h - 04h - 08h - 12h - 16h - 20h"];
_role5 = "MODs Opcionais";
_role5names = ["Enhanced Movement"];
_role6 = "ALERTA";
_role6names = ["Apenas medicos podem reviver"];
_role7 = "IMPORTANTE";
_role7names = ["Divirta-se!!!"];
 
{
	sleep 2;
	_memberFunction = _x select 0;
	_memberNames = _x select 1;
	_finalText = format ["<t size='0.70' color='#FFFFFF' align='right'>%1<br /></t>", _memberFunction];
	_finalText = _finalText + "<t size='0.80' color='#0174DF' align='right'>";
