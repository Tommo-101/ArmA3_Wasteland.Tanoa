...
SL_cleanUpRadius = 30; // maximum radius in meters from store NPC to clean up. (default 15 meters)
SL_cleanUpSleep = 15; // sleep time in seconds per object loop check. (default 10 seconds)
