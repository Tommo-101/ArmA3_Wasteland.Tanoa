...
_vehlisttext = _dialog displayCtrl airshop_veh_TEXT;
_vehlist = _dialog displayCtrl airshop_veh_list;
...
{
	case 0: { call civAirArray };
	case 1: { call gunshipsHeliArray };
	case 2: { call combatJetsArray };
	case 3: { call utilityJetsArray };
	case 4: { call utilityHeliArray };
	case 5: { call specialistAirArray };
	default { [] };
};
