...
_vehText = _dialog displayCtrl airshop_veh_TEXT;
...

{
	...
	{
		_parts pushBack [_animName, _animSrc, airshop_list_checkboxTextures select (_initPhase >= 1)];
	};
