...
private ["_vehshopDialog", "_Dialog", "_playerMoney", "_owner", "_landButton", "_lightInfButton", "_armorButton", "_antiButton", "_tankButton", "_boatButton", "_utilityButton"];
...
_utilityButton = _Dialog displayCtrl vehshop_button6;
