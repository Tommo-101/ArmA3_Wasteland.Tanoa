...
_vehText = _dialog displayCtrl specshop_veh_TEXT;
...

{
	...
	{
		_parts pushBack [_animName, _animSrc, specshop_list_checkboxTextures select (_initPhase >= 1)];
	};
