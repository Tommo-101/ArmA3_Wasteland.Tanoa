...
// ******************************************************************************************
//	@file Version: 1.0
//	@file Name: populateSpecStore.sqf
...
_vehlisttext = _dialog displayCtrl specshop_veh_TEXT;
_vehlist = _dialog displayCtrl specshop_veh_list;
...
_noBuzzard = ["specStore_noBuzzard", true] call getPublicVar;
