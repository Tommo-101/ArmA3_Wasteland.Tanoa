...
applySpecVehicleTexture = "client\systems\specStore\applySpecVehicleTexture.sqf" call mf_compile;
applyAirVehicleTexture = "client\systems\airStore\applyAirVehicleTexture.sqf" call mf_compile;
