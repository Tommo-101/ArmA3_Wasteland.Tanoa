...
// ******************************************************************************************
//	@file Name: mission_AggressiveJet.sqf
...
_setupObjects =
{
	...
	_missionHintText = format ["An pilot has gone rogue and taken a armed <t color='%2'>%1</t>. Shoot it down and kill the pilot to recover the stolen money and weapons!", _vehicleName, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "The sky is clear again, the rogue pilot was taken out! Ammo crates and some money have fallen near the body.";
};
