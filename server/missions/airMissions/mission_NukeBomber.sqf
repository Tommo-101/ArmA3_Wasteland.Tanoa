...
_moneyAmount = Tier_3_Reward;

_setupVars =
{
	_missionType = "Nuclear Bomber Detected!";
...
_setupObjects =
{
	...
	_createVehicle =
	{
		...
		// add another 5 people inside the plane.
	...
	_missionHintText = format ["A <t color='%2'>%1</t>, a known Nuclear Bomber is patrolling the island. Shoot it down before it launches it's payload and recover the money and weapons!", _vehicleName, airMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Great job! The Nuclear Bomber has been taken out. Ammo crates and some money have fallen near the pilot.";
};
