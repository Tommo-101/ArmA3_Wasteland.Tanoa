...
list_drones_emp = _poz_g nearEntities [["B_UAV_05_F", "O_UGV_01_rcws_F", "I_UAV_02_dynamicLoadout_F", "O_UAV_02_dynamicLoadout_F","B_UAV_02_dynamicLoadout_F","B_T_UAV_03_F"],_rang_emp];
